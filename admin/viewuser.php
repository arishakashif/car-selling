...
<body>
<h3><span id="Main" >View Users</span>
...
<br><br>
    <table width="90%" align="center" style="border: 2px solid white;">
      ...
      <tr style="margin: auto; border: 2px solid white; ">
        ...
        <th style= "border-left: 2px inset white;text-align: center;font-size: 20px;"> Username </th>
        <th style= "border-left: 2px inset white;text-align: center;font-size: 20px;"> Password </th>
