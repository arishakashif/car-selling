...
<p class="signin" style="margin-bottom: -30px;"><span style="font-size: 100px; font-family: 'Eczar', serif;">A</span>dd in all Cars</p>
<div class="main">
    

<br><br>

  <form  method="post" action="addinall.php" role="form" enctype="multipart/form-data" class="centered"  >
