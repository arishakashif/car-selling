...
<body>
<h3><span id="Main" >View Reviews</span>
  <br><a id="logout"  href="logout.php">Logout</a></h3>
<br><br>
    <table width="70%" align="center" style="border: 2px solid white;">
      
      <tr style="margin: auto; border: 2px solid white; ">
        <th>  No. </th>
        
        <th style= "border-left: 2px inset white;text-align: center;font-size: 20px;"> Reviews </th>
