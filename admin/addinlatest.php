...
<head>
    ...
    <title>Add In Latest Cars</title>
    <style type="text/css">
.main
...
<p class="signin" style="margin-bottom: -30px;"><span style="font-size: 100px; font-family: 'Eczar', serif;">A</span>dd in latest Cars</p>
<div class="main">
   

<br><br>

  <form  method="post" action="addinlatest.php" role="form" enctype="multipart/form-data" class="centered"  >
