      ...
      <?php   
        ...
        while ($data = mysqli_fetch_assoc($result)) {
          ...
          ?>
            ...
            <td style="	border-left: 2px inset white;"><a href="latestdlt.php?lid=<?php echo $data['id']; ?>"> <button style="width:90%; background-color: black; color: white;margin-left: 12px;">DELETE</button></a></td>
