...
$qry="INSERT INTO `latest cars`(`car name`, `registration number`, `model`, `color`, `price`, `running`, `Package`, `details`, `make`, `image1`, `image2`, `image3`, `image4`, `image5`) VALUES ('$car','$reg','$model','$color','$price','$running','$package','$details','$make','$image1','$image2','$image3','$image4','$image5')";
